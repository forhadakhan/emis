    ...
    return (
        <div className="px-4 py-5">
            ...
            <div className="container py-4">
                ...
                <div class="btn-group" role="group" onClick={() => setGetComponent('CreatePermissionGroup')}>
                    <button type="button" class="btn btn-dark" disabled={getComponent==='CreatePermissionGroup'}>
